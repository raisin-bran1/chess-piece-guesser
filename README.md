...
## Dataset
- Chess positions are extracted from PGN game files on the lichess database and downloaded as tensors.
- Training and evaluation both use a dataset of 100K boards.
...
Correct colors is the percentage of predicted boards where all piece colors match the input. Regular pieces is the percentage where both colors have 1 king and at most 8 pawns, 2 rooks, 2 knights, 2 bishops, 1 queen.

![Accuracy by moves](evals/bar_chart.png)

<p align="center">
  <img src="evals/mlp_basic_heatmap.png" width="350">
  <img src="assets/transformer_basic_heatmap.png" width="350">
</p>
